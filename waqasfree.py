...
\033[37;1m[\033[41;1m FACEBOOK ACCOUNT CLONING \033[00;1m\033[37;1m ]\n
 ...
 \033[32;1mCreator \033[37;1m: \033[33;1mWAQAS
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/waqass55/free/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80WAQAS\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;92m\xe2\x95\xb0\xe2\x94\x80WAQAS\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('clear')
...
def a_s():
    ...
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mRanaMZ [WAQAS]\x1b[0;97m'
    print 47 * '-'
    print ''
